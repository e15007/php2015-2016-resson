    ...
    if ($midnight < $month_nyphp) {
        ...
        if ($timestamp > $meeting_start) {
            ...
            print date('g:i a', $timestamp);
				...
				// ユーザが入力した日時より前に今月のミーティングが開催された(今月はすでに終わった)
				// 場合は来月のミーティングを表示する
